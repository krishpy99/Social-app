...
class EditDetails extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
                <NiceButton tip="Edit Details" onClick={this.handleOpen} btnClassName={classes.bbutton}>
                ...
                maxWidth="sm">
                    ...
                    <DialogContent>
                        <form>
                            <TextField name="bio" type="text" label="Bio" multiline rows="3" placeholder="Something about yourself..." 
                            ...
                            <TextField name="location" type="text" label="Location" placeholder="Directions to your place." 
